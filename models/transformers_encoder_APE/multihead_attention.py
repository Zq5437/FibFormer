...
from models.transformers_encoder_APE.position_embedding import get_rope_matrix
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, pic_size, patch_size,attn_dropout=0.,
                 bias=True, add_bias_kv=False, add_zero_attn=False, device="cuda:1", target_number=10):
        super().__init__()
