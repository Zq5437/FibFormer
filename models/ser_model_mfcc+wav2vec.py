...
class Ser_Model(nn.Module):
    def __init__(self, ratio=None):
        ...
        self.post_spec_mfcc_att_layer = nn.Linear(128, WAV2VEC_PIC_SIZE[0] // WAV2VEC_PATCH_SIZE[0] * WAV2VEC_PIC_SIZE[1] // WAV2VEC_PATCH_SIZE[1])
    ...
    def forward(self, audio_spec, audio_mfcc, audio_wav):      
        ...
        audio_spec_mfcc_att_d = self.post_spec_mfcc_att_dropout(audio_mfcc_p)# [batch, 256] 
        ...
        audio_att = torch.cat([audio_mfcc_p, audio_wav_p], dim=-1)  # [batch, 256] 
